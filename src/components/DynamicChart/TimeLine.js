...
export class TimeLine {
    ...
    timeLine() {
        ...
        let margin = {top: 5, right: 10, bottom: 50, left: 50, sub_top: 20, sub_bottom: 15},
        ...
        function chart(s) {
            ...
            function brushed() {
                ...
                if (data[0].p != undefined) precit_line.attr('d',predictline);
                x_axis.call(xAxis);
                svg.select(".zoom").call(zoom.transform, d3.zoomIdentity
                    .scale(width / (s[1] - s[0]))
                    .translate(-s[0], 0));
            ...
            // Add the predictline path.
            let precit_line = main
                .append("path")
                .datum(data)
                .attr("class", "line")
                .style('fill', 'none')
                ...
                .attr("clip-path", "url(#clip-timeline)")
                .attr("d", function (d) {
                    console.log('pred',d,predictline(d));
